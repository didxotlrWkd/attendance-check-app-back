...
module.exports = async (req, res, next) => {
    try{
        ...
        const token = jwt.verify(refresh_token, process.env.ACCESS_TOKEN_SECRET);
        ...
        const new_access_token = generateToken.access(token.user_id, user.gender);
